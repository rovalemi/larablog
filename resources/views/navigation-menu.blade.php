            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @guest
                    <div class="ms-3 flex items-center gap-4">
                        <a href="{{ route('login') }}" class="text-sm text-gray-600 hover:text-gray-800">Iniciar sesión</a>
                        <a href="{{ route('register') }}" class="text-sm text-gray-600 hover:text-gray-800">Registrarse</a>
                    </div>
                @endguest
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        @guest
            <div class="px-4 py-3 border-t border-gray-200">
                <a href="{{ route('login') }}" class="block text-gray-700 py-2">Iniciar sesión</a>
                <a href="{{ route('register') }}" class="block text-gray-700 py-2">Registrarse</a>
            </div>
        @endguest
    </div>
</nav>
